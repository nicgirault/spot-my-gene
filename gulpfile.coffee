...
gulp.task 'compile', ->
  gulp.src [
    ...
    'src/dendogram/dendogram.coffee'
    'src/dendogram/sample-dendogram.coffee'
    'src/dendogram/gene-dendogram.coffee'
    'src/normalization.coffee'
    'src/zoom.coffee'
    'src/heatmap.coffee'
    'src/legend.coffee'
    'src/pie/pie.coffee'
    'src/pie/sample-pie.coffee'
    'src/pie/gene-pie.coffee'
    'src/common/parameters.coffee'
  ]
